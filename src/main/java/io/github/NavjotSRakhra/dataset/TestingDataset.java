...
public class TestingDataset {
    public static final int DATA_SIZE = 10_000;
    private static final HashMap<Integer, Data> cache = new HashMap<>(10_000);
    ...
    private static final String
            pathToTrainingData = "D:\\Java Projects\\MNISTWithPersonalNeuralNetwork\\src\\main\\resources\\t10k-images-idx3-ubyte",
            pathToTrainingLabels = "D:\\Java Projects\\MNISTWithPersonalNeuralNetwork\\src\\main\\resources\\t10k-labels-idx1-ubyte";
    ...
    private static byte[] getImageAt(int i) throws IOException {
        if (i >= DATA_SIZE)
            throw new ArrayIndexOutOfBoundsException("Index " + i + " out of bounds of " + DATA_SIZE);
